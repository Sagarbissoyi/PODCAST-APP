...
const Header = () => {
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      const res = await axios.get("https://podcast-app-txd7.onrender.com/api/v1/user-details", {
  ...
  const LogoutHandler = async()=> {
    const res=  await axios.post("https://podcast-app-txd7.onrender.com/api/v1/logout",{
      withCredentials : true,
